      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex flex-col">
        <nav className="bg-white/95 backdrop-blur-sm border-b border-gray-100 w-full">
          <div className="max-w-[1440px] mx-auto px-8 md:px-12 h-20 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-10 text-[13px] font-medium tracking-[0.08em] text-black">
              {navLinks.map((link) => (
                <Link
                  key={link.label}
                  to={link.to}
        ...
        <div className="px-8 pt-8 pb-12 space-y-6 text-[15px] font-medium tracking-[0.08em] border-t border-black/10">
          {navLinks.map((link) => (
            <Link
              ...
              hash={link.hash}
              onClick={() => setMenuOpen(false)}
              className="block text-black py-3 text-lg hover:text-[#e07328] transition-colors duration-300 [&.active]:text-[#e07328]"
              style={{ WebkitTapHighlightColor: 'transparent' }}
            >
              {link.label}
            </Link>
      ...
      <div className="max-w-[1440px] mx-auto px-8 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            {/* ── Tres Revoluciones ── */}
            <div className="mt-16">
              <p className="text-[12px] font-medium tracking-[0.3em] uppercase mb-6 text-[#333333]">
                Tres Revoluciones
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
                ...
                <div className="relative border-l-2 border-black/10 md:border-l-0 md:border-t-2 pl-8 md:pl-0 md:pt-8 pb-12 md:pb-0 md:pr-10">
                  ...
                  <p className="text-[14px] font-bold tracking-[0.15em] uppercase mb-3 text-[#333333]">
                    1989
                  </p>
      ...
      <div className="max-w-[1440px] mx-auto px-8 md:px-12 py-16 md:py-28">
        <div className="mb-20">
          <h2 className="text-[clamp(1.75rem,3.5vw,3.5rem)] leading-[1.1] tracking-[-0.02em] mb-10">
            <span className="font-light text-[#333333]">Soluciones </span>
          ...
          <div className="max-w-2xl space-y-6">
            <p className="text-[15px] text-[#333333] leading-[1.85] tracking-[0.005em] font-light">
        ...
        <div className="max-w-[1440px] mx-auto px-8 md:px-12">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                {['Presencial u online', 'Individual o grupal', 'Sin experiencia previa', 'Segunda Edición Latam'].map((tag) => (
                  <span key={tag} className="px-3.5 py-1.5 bg-neutral-50 border border-neutral-100 text-[#333333] text-[12px] font-medium rounded-full">
                    {tag}
                  </span>
                ))}
              </div>
          ...
          <div className="border-t border-neutral-100 pt-16 mb-16">
            <div className="mb-12">
              ...
              <p className="text-[15px] text-[#333333] font-light mt-2 max-w-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-24 pt-16 border-t border-neutral-100">
            ...
            <div className="space-y-6 bg-white border border-[#e0e0e0] p-8">
              ...
              <p className="text-[14px] text-[#444444] leading-[1.7]">
              ...
              <div className="space-y-4 pt-2">
                <div className="border-l-2 border-[#e07328] pl-4">
                  ...
                  <p className="text-[13px] text-[#444444] mt-0.5">Control de iluminación, óptica y composición para eliminar el azar en la generación.</p>
                </div>
                <div className="border-l-2 border-[#e07328] pl-4">
                  <h5 className="text-[14px] font-bold text-black">Ingeniería de Prompt Visual</h5>
                  <p className="text-[13px] text-[#444444] mt-0.5">Traducción de ideas abstractas en parámetros estructurados y predecibles.</p>
                </div>
                <div className="border-l-2 border-[#e07328] pl-4">
                  <h5 className="text-[14px] font-bold text-black">Agente Personalizado</h5>
                  <p className="text-[13px] text-[#444444] mt-0.5">Entrenamiento de una base de conocimiento que almacena y replica tu línea estética.</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6 bg-white border border-[#e0e0e0] p-8">
              ...
              <ul className="space-y-4 pt-2 text-[15px] text-[#444444]">
                {[
            ...
            <div className="space-y-6 bg-white border border-[#e0e0e0] p-8">
              ...
              <div className="space-y-3 pt-2">
                {[
                  ...
                  <div key={mat.title} className="bg-[#f5f5f5] p-4">
                    <h5 className="text-[14px] font-bold text-black">{mat.title}</h5>
                    <p className="text-[12px] text-[#444444] mt-1 leading-relaxed">{mat.desc}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start mt-24 pt-16 border-t border-neutral-100">
            ...
            <div className="lg:col-span-9 space-y-4">
              ...
              <p className="text-[15px] text-[#333333] leading-[1.8] font-light max-w-4xl">
              ...
              <div className="border-l-2 border-[#e07328] pl-5 mt-4">
                <p className="text-[14px] text-[#333333] italic leading-[1.7] font-light max-w-3xl">
...
export function Hero() {
  return (
    <section className="relative w-full overflow-hidden bg-white">
      <div className="relative w-full max-w-[1440px] mx-auto px-8 md:px-12 py-16 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-10 lg:gap-16 items-center">
          {/* ── Columna izquierda — texto ── */}
          <div className="order-2 lg:order-1">
            {/* Eyebrow — palabra clave corta */}
            <div className="mb-7 text-[12px] font-medium tracking-[0.35em] uppercase text-[#333333]">
              Estudio Visual
            </div>

            {/* Título de marca — todas las palabras mismo peso, "QUIERAS" en naranja */}
            <p className="font-sans font-bold tracking-[-0.01em] leading-[1] text-[clamp(1.5rem,3.6vw,2.5rem)] text-black">
              HAZ LO QUE <span className="text-[#e07328]">QUIERAS</span>
            </p>

            {/* Frase protagonista — letra negra, bold, grande, máximo protagonismo */}
            <h1 className="mt-6 font-sans font-bold text-black leading-[1.03] tracking-[-0.03em] text-[clamp(2.75rem,6vw,5.25rem)]">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              ...
              <Link
                to="/"
                hash="formacion"
                className="inline-flex items-center px-8 py-4 border border-neutral-300 text-neutral-900 text-[12px] font-bold tracking-[0.12em] uppercase hover:border-[#e07328] hover:text-[#e07328] transition-colors duration-300 cursor-pointer"
              >
                Formación
              </Link>
          ...
          {/* ── Columna derecha — imagen destacada (mamá con su bebé) ── */}
          <div className="order-1 lg:order-2">
            <div className="relative aspect-[4/5] w-full overflow-hidden shadow-[0_30px_70px_-30px_rgba(0,0,0,0.35)]">
              <img
                src="/hero-mama-bebe.jpg"
